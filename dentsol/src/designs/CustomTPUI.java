 ...
 * @author RAVEN
 */
public class CustomTPUI extends BasicTabbedPaneUI {

	private final CustomTP tab;

	public CustomTPUI(CustomTP tab) {
		this.tab = tab;
	}
	...
	protected void paintTabBackground(Graphics2D g2, int index, boolean selected) {
		...
		g2.drawImage(new CShadow(6, 0.8f, new Color(50, 50, 50)).createShadow(shape), rec.x, rec.y, null);
		g2.fill(shape);
	}
